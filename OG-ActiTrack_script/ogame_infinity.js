...
class OGInfinity {
    ...
    sideOptions() {
        ...
        let empireBtn;
        this.commander && (empireBtn = harvestOptions.appendChild(this.createDOM("div", {
    ...
    generalStats(player) {
        ...
        playerDiv.appendChild(this.createDOM("div", {
        ...
        innerAstro.appendChild(this.createDOM("a", {
        ...
        innerEnergy.appendChild(this.createDOM("a", {
        ...
        innerPlasma.appendChild(this.createDOM("a", {
    ...
    betterFleetDispatcher() {
        if (this.page == "fleetdispatch" && document.querySelector("#civilships") && fleetDispatcher.shipsOnPlanet.length != 0) {
            ...
            let missionsDiv = destination.appendChild(this.createDOM("div", {
                class: "ogl-missions",
                id: "missionsDiv"
            }));
            missionsDiv.html(`<span style="color: #9099a3"> No missions... </span>`);
    ...
    activitytimers() {
        ...
        this.planetList.forEach((planet => {
            ...
            let pTimer = planet.querySelector(".planetlink").appendChild(this.createDOM("div", {
    ...
    targetList(show) {
        let renderTagetList = () => {
            ...
            for (let i = 1; i <= 10; i++) {
                let gTab = galaxyTabList.appendChild(this.createDOM("div", {
                    class: "ogl-tab",
                    "data-galaxy": i
                }, "G" + i));
    ...
    stalk(sender, player, delay) {
        ...
        let render = player => {
            ...
            let actBtn = actions.appendChild(this.createDOM("a", {
    ...
    sortTable(arr) {
        ...
        arr.forEach((async (report, index) => {
            ...
            let date = line.appendChild(this.createDOM("td", {
                class: "tooltipLeft ogl-date",
                title: dateDetail
            }, dateText));
            ...
            let total = line.appendChild(this.createDOM("td", {
                class: "tooltipLeft ogl-lootable",
                title: totalDetail
    ...
    settings() {
        ...
        dataBtns.appendChild(this.createDOM("label", {
            for: "file",
            class: "btn_blue",
